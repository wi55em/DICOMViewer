...
namespace DICOMcloud.DataAccess.Database
{
    static class SqlInsertStatments
    {
        ...
        const string PatientTableName        = "DICOM_PATIENT";
        const string StudyTableName          = "DICOM_STUDY";
        const string SeriesTableName         = "DICOM_SERIES";
        const string ObjectInstanceTableName = "DICOM_OBJECT_INSTANCE";
