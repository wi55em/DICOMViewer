...
namespace DICOMcloud.DataAccess.Database.Schema
{
    public class StorageDbSchemaProvider : DbSchemaProvider
    {
        ...
        {
            if ( queryLevel == Enum.GetName ( typeof(ObjectQueryLevel), ObjectQueryLevel.DICOM__OBJECT_INSTANCE ) )
            {
        ...
        public const string PatientTableName        = "DICOM_PATIENT" ;
        public const string StudyTableName          = "DICOM_STUDY" ;
        public const string SeriesTableName         = "DICOM_SERIES" ;
        public const string ObjectInstanceTableName = "DICOM_OBJECT_INSTANCE" ;

        public class MetadataTable
        {
            public static string TableName         = "DICOM_OBJECT_INSTANCE";
