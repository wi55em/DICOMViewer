...
class QueryView {
    ...
    private createSeriesTemplate() {
        $.get(this.getTemplateRelativePath("/SeriesItem"), (data: any, textStatus: string, jqXHR: JQueryXHR) => {
            this._$seriesItemTemplate = $(data);
        }, "html");
    }

    private createInstanceTemplate() {
        $.get(this.getTemplateRelativePath("/InstanceItem"), (data: any, textStatus: string, jqXHR: JQueryXHR) => {
